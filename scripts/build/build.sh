...
# This array contains a list of target platforms for which the binary will be
# built. Each element is a tuple with two values:
...
for TARGET in "${TARGETS[@]}"; do
  ...
  # Call the invoke_binary_build function to build the binary and create the
  # archive
